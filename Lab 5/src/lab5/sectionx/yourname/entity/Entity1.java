...
{    
    ...
    public Entity1()
    {
        System.out.println("At time: " + NetworkSimulator.time + ". Creating Node 1.");
        ...
        // Initialize distance table with known values from Node 1
        distanceTable[0][0] = 1;
        distanceTable[1][1] = 0;
        distanceTable[2][2] = 1;
        ...
        Packet packet1 = new Packet(1, 0, connections);
        Packet packet2 = new Packet(1, 2, connections);
        
        // Send created packets to each neighbour
        NetworkSimulator.toLayer2(packet1);
        NetworkSimulator.toLayer2(packet2);
        
        // Print Node 1's distance table
        System.out.println("At time: " + NetworkSimulator.time + ". Initial Node 1 distance table:");
        printDT();
    }
