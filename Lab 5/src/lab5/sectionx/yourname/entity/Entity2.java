...
{    
    ...
    public Entity2()
    {
        System.out.println("At time: " + NetworkSimulator.time + ". Creating Node 2.");
        ...
        // Initialize distance table with known values from Node 2
        distanceTable[0][0] = 3;
        distanceTable[1][1] = 1;
        distanceTable[2][2] = 0;
        distanceTable[3][3] = 2;
        ...
        Packet packet1 = new Packet(2, 0, connections);
        Packet packet2 = new Packet(2, 1, connections);
        Packet packet3 = new Packet(2, 3, connections);
        ...
        // Print Node 2's distance table
        System.out.println("At time: " + NetworkSimulator.time + ". Initial Node 2 distance table:");
        printDT();
    }
