...
{    
    ...
    public Entity0()
    {
        System.out.println("At time: " + NetworkSimulator.time + ". Creating Node 0.");
        ...
        // Initialize distance table with known values from Node 0
        distanceTable[0][0] = 0;
        distanceTable[1][1] = 1;
        distanceTable[2][2] = 3;
        distanceTable[3][3] = 7;
        ...
        Packet packet1 = new Packet(0, 1, connections);
        Packet packet2 = new Packet(0, 2, connections);
        Packet packet3 = new Packet(0, 3, connections);
        ...
        // Print Node 0's distance table
        System.out.println("At time: " + NetworkSimulator.time + ". Initial Node 0 distance table:");
        printDT();
    }
    ...
    {   
        ...
        // If the value in the table is greater than value from the received packet + distance from source Node, update the Node to the new minimum
        for (int i = 0; i < distanceTable.length; i++){
